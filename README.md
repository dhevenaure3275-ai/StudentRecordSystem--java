# StudentRecordSystem--java
 Student Record System using Java for BSIS portfolio this program is for beginners only.
StudentRecordSystem.java
...
public class StudentRecordSystem {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Credit to: Dheven_Aure_25");
            System.out.println("If you encounter some problem please report to developer");
